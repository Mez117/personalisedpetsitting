        ...
        <v-responsive>
            ...
            >
                ...
                <swiper-slide>
                    ...
                    >
                        <div class="boxes tiny-boxes big-img">  
                            <v-img draggable="false" :src="r16" class="gap" cover alt=""></v-img>
                        </div> 
                        <h1 class="text-h5 mt-10">Carol, Douglas</h1>
                        <p class="mt-2 text-justify">
                ...
                <swiper-slide>
                    ...
                    >
                        <div class="boxes tiny-boxes big-img">  
                            <v-img draggable="false" :src="r17" class="gap" cover alt=""></v-img>
                        </div> 
                        <h1 class="text-h5 mt-10">Cassandra</h1>
                        <p class="mt-2 text-justify">
                ...
                <swiper-slide>
                    ...
                    >
                        <div class="boxes tiny-boxes big-img">  
                            <v-img draggable="false" :src="r18" class="gap" cover alt=""></v-img>
                        </div> 
                        <h1 class="text-h5 mt-10">Clarissa</h1>
                        <p class="mt-2 text-justify">
                            I have no words! Lara, is bubbly, sweet and energetic, she didn't rest, she made sure she was available to play with my high energy girl. She is amazing! I could not recommend her, on this platform any higher. She is amazing
                        </p>
                    </v-card>
                </swiper-slide>
                <swiper-slide>
                    ...
                    >
                        <div class="boxes tiny-boxes big-img">  
                            <v-img draggable="false" :src="r12" class="gap" cover alt=""></v-img>
                        </div> 
                        <h1 class="text-h5 mt-10">Sarah</h1>
                        <p class="mt-2 text-justify">
                ...
                <swiper-slide>
                    ...
                    >
                        <div class="boxes tiny-boxes big-img">  
                            <v-img draggable="false" :src="r15" class="gap" cover alt=""></v-img>
                        </div> 
                        <h1 class="text-h5 mt-10">Nerida</h1>
                        <p class="mt-2 text-justify">
                        ...
                        <v-row justify="center mt-0" no-gutters="">
                            <v-col cols="6">
                                <div class="boxes tiny-boxes mr-2" style="width: 90%">
                                    <v-img draggable="false" :src="r19" class="gap" cover alt=""></v-img>
                                </div>
                                <div class="boxes tiny-boxes" style="width: 90%">
                                    <v-img draggable="false" :src="r14" class="gap" cover alt=""></v-img>
                                </div>
                            </v-col>
                            <v-col cols="6">
                                <div class="boxes tiny-boxes" style="width: 90%; margin-top: 75px;">
                                    <v-img draggable="false" :src="r20" class="gap" cover alt=""></v-img>
                                </div>
                            </v-col>
                        </v-row>
                        <h1 class="text-h5 mt-3">Lisa & Dave</h1>
                        <p class="mt-2 text-justify">
                ...
                <swiper-slide>
                    ...
                    >
                        <v-row justify="center mt-0" no-gutters="">
                            <v-col cols="6">
                                <div class="boxes tiny-boxes mr-2" style="width: 90%">
                                    <v-img draggable="false" :src="r10" class="gap" cover alt=""></v-img>
                                </div>
                                <div class="boxes tiny-boxes" style="width: 90%">
                                    <v-img draggable="false" :src="r9" class="gap" cover alt=""></v-img>
                                </div>
                            </v-col>
                            <v-col cols="6">
                                <div class="boxes tiny-boxes" style="width: 90%; margin-top: 75px;">
                                    <v-img draggable="false" :src="r8" class="gap" cover alt=""></v-img>
                                </div>
                            </v-col>
                        </v-row>
                        <h1 class="text-h5 mt-3">Leanne and Mario</h1>
                        <p class="mt-2 text-justify">
                ...
                <swiper-slide>
                    ...
                    >
                        <div class="boxes tiny-boxes big-img">  
                            <v-img draggable="false" :src="r21" class="gap" cover alt=""></v-img>
                        </div> 
                        <h1 class="text-h5 mt-10">Carmen & Sam</h1>
                        <p class="mt-2 text-justify">
                ...
                <swiper-slide>
                    ...
                    >
                        <v-row justify="center mt-0">
                            <div class="boxes tiny-boxes mr-2" style="margin-top: 75px">
                                <v-img draggable="false" :src="r13" class="gap" cover alt=""></v-img>
                            </div>
                            <div class="boxes tiny-boxes">
                                <v-img draggable="false" :src="r22" class="gap" cover alt=""></v-img>
                            </div>
                        </v-row>
                        <h1 class="text-h5 mt-10">Bec & Rohan</h1>
                        <p class="mt-2 text-justify">
                ...
                <swiper-slide>
                    ...
                    >
                        <div class="boxes tiny-boxes big-img">  
                            <v-img draggable="false" :src="r11" class="gap" cover alt=""></v-img>
                        </div> 
                        <h1 class="text-h5 mt-10">Jess</h1>
                        <p class="mt-2 text-justify">
...
export default {
    ...
    data () {
        return {
            ...
            r8: "/PetSitting/reviews/r8.jpg",
            r9: "/PetSitting/reviews/r9.jpg",
            r10: "/PetSitting/reviews/r10.jpg",
            r11: "/PetSitting/reviews/r17.jpg",
            r12: "/PetSitting/reviews/r12.jpg",
            r13: "/PetSitting/reviews/r13.jpg",
            r14: "/PetSitting/reviews/r14.jpg",
            r15: "/PetSitting/reviews/r15.jpg",
            r16: "/PetSitting/lara_dogs/pbatchtwo5.jpg",
            r17: "/PetSitting/lara_dogs/dog9.jpg",
            r18: "/PetSitting/lara_dogs/pbatchtwo4.jpg",
            r19: "/PetSitting/lara_dogs/dog12.jpg",
            r20: "/PetSitting/reviews/r16.jpg",
            r21: "/PetSitting/lara_dogs/dog10.jpg",
            r22: "/PetSitting/lara_dogs/pbatchtwo7.jpg",
        }
    },
    setup() {
